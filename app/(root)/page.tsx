  ...
  return (
    <>
      <section className="section flex flex-col md:flex-row justify-center gap-5 items-center container">
        <Image src={HeroImage} alt='hero' id='hero_image' className='max-w-[200px] md:max-w-sm w-full h-auto'/>
        <div className='flex text-center md:text-left flex-col gap-2 max-w-lg'>
          ...
          <Link className='button mt-5 max-w-55 w-full mx-auto md:mx-0 text-center' href={'./'}>ПОЧАТИ УЖЕ</Link>
        </div>
      </section>
      <section className='section flex flex-col gap-2 container'>
        ...
        <Link href='/course' className='button w-full max-w-[350px] sm:max-w-64 mt-5 mx-auto'>Всі курси</Link>
      </section>
      <section className='section container'>
        ...
        <div className='flex gap-7 flex-wrap justify-between mt-10'>
          <div className='flex flex-col items-center text-center gap-4 max-w-[300px] mx-auto'>
            <Image src={Advantages01} alt='Advantage'  />
          ...
          <div className='flex flex-col items-center text-center gap-4 max-w-[300px] mx-auto'>
            <Image src={Advantages02} alt='Advantage'  />
          ...
          <div className='flex flex-col items-center text-center gap-4 max-w-[300px] mx-auto'>
            <Image src={Advantages03} alt='Advantage'  />
